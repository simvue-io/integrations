...
def test_moose_connector(offline, parallel):
    ...
    run_id = moose_example("/opt/moose/bin/moose-opt", offline, parallel)
    ...
    assert metrics["average_temperature"]["last"] > 498
    ...
    assert metrics["temperature_along_bar.T.1"]["last"] > 498
